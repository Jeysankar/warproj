	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(errorMsg != null){
			...
			try {
				...
				User reqUser = new User(name, email, country, password);
				userBao.registerUser(reqUser);
				...
				messageService.sendMessage(reqUser);
				
				logger.info("Send email successful to: "+email);
